...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
   ...
   <div class="w-100 d-flex justify-content-center m-2">
    <form action="createUser" method="POST">
      Имя покупателя <input type="text" name="firstname" value="${user.reader.firstname}"><br>
      Фамилия покупателя <input type="text" name="lastname"  value="${user.reader.lastname}"><br>
